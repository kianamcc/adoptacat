...
const Home = () => {
  ...
  //             // let op = 1;
  //             let d = axios.get(
  //               `https://api.petfinder.com/v2/animals?type=cat&limit=25&page=${page}`,
  //               {
  //                 headers: {
  ...
  //             results.push(d);
  //           }
  //           let res = await axios.all(results); // returns array of promises
  //           for (var i of res) {
  //             //console.log(i.data.animals);
  //             allCats.push(i.data.animals);
  //             //setFilteredCats((arr) => [...arr, i.data.animals]);
  //           }
  //           //console.log("all", allCats.flat());
  //           setFilteredCats(allCats.flat());
  //         } catch (err) {
  //           console.log(err);
  //         }
  //       }
  //       fetchData();
  //       if (isFilterOn) {
  //         console.log("fil on in cp, current cats are: ", cats);
  //         //onSelect(selectList, "");
  //       }
  //     });
  // }, [url]);
...
//   // client credentials authorization flow is used to obtain an access token to authorize API requests
//   const url = `https://api.petfinder.com/v2/animals?type=cat&limit=25&page=${currentPage}`;
...
//   // const onSelect = (selectedList, selectedItem) => {
//   //   setShowFilteredCats(true);
//   //   console.log("s list", selectedList);
//   //   var testarr = [];
//   //   var match = true;
...
//   //       else if (i["cat"] === "Breeds") {
//   //         //console.log("breeds", cat.breeds["primary"], i["key"]);
//   //         if (Object.values(cat.breeds).includes(i["key"])) {
//   //           //console.log("breed match", cat.breeds["primary"]);
//   //           match = true;
//   //         } else {
//   //           match = false;
//   //         }
...
//   //       else if (!Object.values(cat).includes(i["key"])) {
//   //         match = false;
//   //         console.log("not a match..");
//   //         break inner;
//   //       }
...
//   //   console.log(testarr);
//   //   setFilteredCats(testarr);
//   //   // console.log("fcats", filteredCats);
//   // };
